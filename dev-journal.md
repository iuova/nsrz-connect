...
## [2025-06-09 15:46:00]
### Обновление компонента UsersTab

- Добавлено логирование для отслеживания загрузки пользователей и обработки ошибок.
- Исправлено отображение названия отдела на "Подразделение" и обновлено поле для отображения имени подразделения.

Изменения затронули файл: UsersTab.js.

## [2025-06-09 16:45:00]
Добавление функциональности редактирования сотрудников в компонент EmployeesTab

- Добавлен новый компонент EmployeesEditor для редактирования информации о сотрудниках.
- Реализована возможность двойного клика по строке таблицы для открытия редактора сотрудника.
- Оптимизирован код для улучшения читаемости и поддержки.

Изменения затронули файлы: EmployeesTab.js, EmployeesEditor.js.